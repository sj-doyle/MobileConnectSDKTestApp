...
import com.gsma.android.utils.ParameterList;
...
//			activity.addView(activity, new LayoutParams(LayoutParams.FILL_PARENT,LayoutParams.FILL_PARENT));
			
			final WebView view = (WebView) new WebView(activity);
