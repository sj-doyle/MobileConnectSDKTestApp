...
public class UserinfoAddress implements Serializable {
	...
	public UserinfoAddress(JSONObject jsonObject) throws JSONException {
		if (jsonObject != null) {
			if (jsonObject.has("formatted")) this.formatted = jsonObject.getString("formatted");
			if (jsonObject.has("street_address")) this.street_address = jsonObject.getString("street_address");
			if (jsonObject.has("locality")) this.locality = jsonObject.getString("locality");
			if (jsonObject.has("region")) this.region = jsonObject.getString("region");
			if (jsonObject.has("postal_code")) this.postal_code = jsonObject.getString("postal_code");
