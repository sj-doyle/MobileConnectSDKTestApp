...
//	������},
	...
	public DiscoveryResponse(JSONObject jsonObject) throws JSONException {
		if (jsonObject != null) {
			if(jsonObject.has("client_id")) this.client_id = jsonObject.getString("client_id");
			if(jsonObject.has("client_secret")) this.client_secret = jsonObject.getString("client_secret");
			if(jsonObject.has("subscriber_operator")) this.subscriber_operator = jsonObject.getString("subscriber_operator");
			if(jsonObject.has("country")) this.country = jsonObject.getString("country");
			if(jsonObject.has("currency")) this.currency = jsonObject.getString("currency");
			if(jsonObject.has("subscriber_id")) this.subscriber_id = jsonObject.getString("subscriber_id");
